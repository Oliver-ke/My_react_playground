...
// If you are not using react, just import from "emotion"
...
const App = () => (
  <Wrapper className={css({ display: "block" })}>
    <Wrapper>
      ...
      <a href="https://emotion.sh" className={linkClass}>
        emotion.sh
      </a>
      <a href="https://github.com/emotion-js/emotion" className={linkClass}>
        github
      </a>
    </Wrapper>
    <div
    ...
    >
      ...
      >
        ...
        notation, in the following order: Byte 1: red value (color type red)
        Byte 2: green value (color type green) Byte 3: blue value (color type
        blue) For example, consider the color where the red/green/blue values
        are decimal numbers: red=36, green=104, blue=160 (a grayish-blue color).
        The decimal numbers 36, 104 and 160 are equivalent to the hexadecimal
      ...
      <ComposeBox border color="MidnightBlue">
        This is some text in a composed box.
      </ComposeBox>
    </div>
  </Wrapper>
);
